...
import '../follower_list1_screen/widgets/follower_list1_item_widget.dart';
...
class FollowerList1Screen extends StatelessWidget {
  @override
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: (){
                                                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>FollowingListScreen()));
                                                        },
                                                        child: Text(
                                                          "Followings",
                                                          overflow:
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: (){
                                                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>FollowerListScreen()));
                                                        },
                                                        child: Text(
                                                          "Followers",
                                                          overflow:
                                ...
                                Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return FollowerList1ItemWidget();
                                    },
                                  ),
                                ),
                              ],
